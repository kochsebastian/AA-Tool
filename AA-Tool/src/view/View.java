...
public class View implements ActionListener {
    ...
    public static Aufwandsabschaetzung a;			//SINN?
   
   // private JPanel aufwandsabschaetzungJPanel;
   // private ViewAufwandsabschaetzung aPanel; //für Action Listener
    ...
    public void displayView2(ActionListener actionListener)
    {
    	setWindow();
        // Beim Betätigen des [x]-Buttons: Java-Programm beenden
        hauptfenster.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        ...
        */
        ...
        // Buttons dem Listener zuordnen
        fuegeFunktionenReiheHinzu.addActionListener(actionListener);
        loescheFunktionenReihe.addActionListener(actionListener);
        ...
        // Buttons dem Listener zuordnen
        fuegeLeistungenReiheHinzu.addActionListener(actionListener);
        loescheLeistungenReihe.addActionListener(actionListener);
        ...
        // Buttons dem Listener zuordnen
        fuegeQualitaetsanforderungenReiheHinzu.addActionListener(actionListener);
        loescheQualitaetsanforderungenReihe.addActionListener(actionListener);
 ...
 /*
    public void addViewAufwandsabschaetzung(){
    	aufwandsabschaetzungJPanel = new JPanel();
    	aPanel = new ViewAufwandsabschaetzung();
        aufwandsabschaetzungJPanel.add(aPanel);
    }*/
    ...
    @Override
    public void actionPerformed(ActionEvent ae) {								//Refaktoring: else if
